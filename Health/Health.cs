    ...
    public sealed class Health
    {
        ...
        public int Max
        {
            ...
            set
            {
                ...
                //Если оставить возможность уменьшения макс значения ниже нуля, то в строке 39 (_value = _max) в наше количество здоровья запишется отрицательное значение здоровья.
